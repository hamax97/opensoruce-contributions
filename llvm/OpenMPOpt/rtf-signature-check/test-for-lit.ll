...
entry:
  ...
  call void (%struct.ident_t*, float, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull @0, float 0.0, void (i32*, i32*, ...)* bitcast (void (i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*))
  ret i32 0
}
...
declare !callback !2 void @__kmpc_fork_call(%struct.ident_t*, float, void (i32*, i32*, ...)*, ...)
